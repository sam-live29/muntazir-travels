    ...
    <div className="bg-slate-50 min-h-full flex flex-col">
      ...
      <main className="flex-1 p-6 flex flex-col items-center justify-center">
        <div className="w-full bg-white rounded-3xl p-6 shadow-sm border border-slate-100 max-w-sm">
          <h2 className="text-2xl font-black text-slate-900 mb-6 text-center">Login</h2>
          ...
          <form onSubmit={isForgotPassword ? handleForgotPassword : handleSignIn}>
            ...
            {isForgotPassword && (
              <button
                ...
                className="w-full text-xs font-bold text-slate-500 hover:text-slate-900 transition-colors mb-4"
              >
                Back to Login
              </button>
            )}
